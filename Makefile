...
executions_src = execution/signal.c execution/cd.c execution/pipe.c execution/utils.c execution/errors.c execution/pipe_utils.c execution/main.c execution/process_utils.c
