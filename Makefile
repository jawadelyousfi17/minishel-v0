...
token = tokenizer/check_ambs.c tokenizer/check_syntax.c tokenizer/exec_here_doc.c tokenizer/expand_here_doc.c tokenizer/expand_quotes.c tokenizer/expand_vars_0.c tokenizer/expand_vars_1.c tokenizer/init_data.c tokenizer/initialize.c tokenizer/join_tokens.c tokenizer/tokenizer.c tokenizer/tokenizer_1.c tokenizer/tokenizer_2.c
...
utils_obj = $(utils:.c=.o)
readline = -lreadline -L /goinfre/jel-yous/homebrew/opt/readline/lib -I /goinfre/jel-yous/homebrew/opt/readline/include
